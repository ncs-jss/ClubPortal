angular.module('ClubPortal', ['ngRoute', 'auth', 'events', 'club', 'LocalStorageModule', '720kb.datepicker', 'ngScrollTo']).config(function(localStorageServiceProvider, $locationProvider) {
